...
{
	static LPFN_DISCONNECTEX pDisconnectEx( nullptr );
	
	if( pDisconnectEx == nullptr ){
		GUID guidDisconnectEx = WSAID_DISCONNECTEX;
		DWORD dwBytes;
		WSAIoctl( hSocket, SIO_GET_EXTENSION_FUNCTION_POINTER, &guidDisconnectEx, sizeof( guidDisconnectEx ), &pDisconnectEx, sizeof( pDisconnectEx ), &dwBytes, NULL, NULL );
	}
	...
	DWORD dwLocalAddressLength, DWORD dwRemoteAddressLength, LPDWORD lpdwBytesReceived, LPOVERLAPPED lpOverlapped)
{
	...
	if( pAcceptEx == nullptr ){
		...
		DWORD dwBytes;
		WSAIoctl( sListenSocket, SIO_GET_EXTENSION_FUNCTION_POINTER, &guidAcceptEx, sizeof( guidAcceptEx ), &pAcceptEx, sizeof( pAcceptEx ), &dwBytes, NULL, NULL );
	}
